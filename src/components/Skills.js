    ...
    <div class="inner">
      ...
      <div class="container">
        ...
        <div class="skill-box">
          <div class="skill-title">
            <div class="img">
              <img src="" class="skill-icon" alt="skills" />
            </div>
          </div>
        </div>
      </div>
      <div class="container2">
        <div class="skill-box">
          <div class="skill-title">
            <div class="img">
              <img
                src="https://serviot.com/wp-content/uploads/2020/09/Hadoop-logo.png"
                alt="hadoop"
                class="skill-icon2"
              />
            </div>
        ...
        <div class="skill-box">
          <div class="skill-title">
            <div class="img">
              <img
                src="https://bi-insider.com/wp-content/uploads/2022/02/apache-cassandra-logo.png"
                alt="cassandra"
                class="skill-icon2"
              />
            </div>
      ...
      <div class="container3">
        ...
        <div class="skill-box">
          <div class="skill-title">
            <div class="img">
              <img
                src="https://i0.wp.com/softwareengineeringdaily.com/wp-content/uploads/2018/07/jupyter-logo-featured-image.png?fit=600%2C315&ssl=1"
                alt="jupyter"
                class="skill-icon2"
              />
            </div>
        ...
        <div class="skill-box">
          <div class="skill-title">
            <div class="img">
              <img
                src="https://cdn.hashnode.com/res/hashnode/image/upload/v1657098680857/FoZEEuklb.png?auto=compress,format&format=webp"
                alt="pytest"
                class="skill-icon2"
              />
            </div>
        ...
        <div class="skill-box">
          <div class="skill-title">
            <div class="img">
              <img
                src="https://miro.medium.com/v2/resize:fit:1400/1*-dNH8WI8Oy3etClaRvRCgw.png"
                alt="nltk"
                class="skill-icon2"
              />
            </div>
      ...
      <div class="container4">
        ...
        <div class="skill-box">
          <div class="skill-title">
            <div class="img">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e3/Jenkins_logo_with_title.svg/1280px-Jenkins_logo_with_title.svg.png"
                alt="jenkins"
                class="skill-icon2"
              />
            </div>
      ...
      <div class="container5">
        ...
        <div class="skill-box">
          <div class="skill-title">
            <div class="img">
              <img
                src="https://pentagram-production.imgix.net/ea053844-c063-4130-9425-4a193f82e1e3/ps_windows_01.jpg?crop=edges&fit=crop&h=630&rect=67%2C364%2C1665%2C1040&w=1200"
                alt="windows"
                class="skill-icon2"
              />
            </div>
      ...
      <div class="container5">
        ...
        <div class="skill-box">
          <div class="skill-title">
            <div class="img">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/2/22/Hibernate_logo_a.png"
                alt="hibernate"
                class="skill-icon2"
              />
            </div>
      ...
      <div class="container5">
        <div class="skill-box">
          <div class="skill-title">
            <div class="img">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/Tableau_Logo.png/640px-Tableau_Logo.png"
                alt="tableau"
                class="skill-icon2"
              />
            </div>
        ...
        <div class="skill-box">
          <div class="skill-title" alt="seaborn">
            <div class="img">
              <img
